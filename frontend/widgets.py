...
def _(__file__):
    ...
    from eun_chae_s.drag_the_words.implementation.DragWordsWidget import DragWordsWidget
    from evence_wang.FileUploaderModule.FileUploader import FileUploader
    from Barsamyan_D.str_strip_plugin_david.StructureStripWidget import StructureStripWidget
    return (
        DragWordsWidget,
        FileUploader,
        Path,
